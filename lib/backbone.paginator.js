    ...
    */
    _checkState: function (state) {
      ...
      if (totalRecords != null && pageSize != null && currentPage != null &&
        ...
        if (pageSize < 1) {
          console.warn("`pageSize` must be >= 1");
          return false;
        }
        ...
        if (firstPage < 0 || firstPage > 1) {
          console.warn("`firstPage must be 0 or 1`");
          return false;
        }
        ...
        if (mode == "infinite") {
          if (!links[currentPage + '']) {
            console.warn("No link found for page " + currentPage);
            return false;
          }
        }
          ...
          console.warn("`currentPage` must be firstPage <= currentPage " +
                               (firstPage ? "<" : "<=") +
